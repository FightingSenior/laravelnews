    ...
    <div class="content menu-structure">
      ...
      <form method="post">
        <ul class="nav" id="my-ui-list">
          <li>
            <div class="sortable">Menu 1</div>
          </li>
          <li>
            <div class="sortable">Menu 2</div>
          </li>
          <li>
            <div class="sortable">Menu 3</div>
          </li>
          <li>
            <div class="sortable">Menu 4</div>
          </li>
          <li>
            <div class="sortable">Menu 5</div>
          </li>
          <li>
            <div class="sortable">Menu 6</div>
          </li>
        </ul>
