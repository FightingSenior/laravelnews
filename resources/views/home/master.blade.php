...
<head>
    ...
    <link href="{{url('homestyle/css/bootstrap.min.css')}}" rel="stylesheet" />
    <link href="{{url('homestyle/css/bootstrap-theme.min.css')}}" rel="stylesheet" />
    <link href="{{url('homestyle/style.css')}}" rel="stylesheet" />
    <script src="{{url('homestyle/js/$.min.js')}}"></script>
    <script src="{{url('homestyle/js/bootstrap.min.js')}}"></script>
</head>
...
<body>
    ...
    <div class="col-md-12 top" id="top">
        <div class="col-md-9 top-left">
            <div class="col-md-3">
                <span class="day">{{Carbon\Carbon::now()->format('l, d/m/Y')}}</span>
            </div>
            <div class="col-md-9">
        ...
        <div class="col-md-3">
            <a href="#"><img src="{{url('homestyle/images/icon-fb.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-twitter.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-google.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-insta.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-pin.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-youtube.png')}}" /></a>
        </div>
    </div>
    ...
    <div class="col-md-12 brand">
        ...
        <div class="col-md-8">
            <img src="{{url('homestyle/images/final-news-site_06.gif')}}" width="100%')}}" />
        </div>
    </div>
    ...
    <div class="col-md-12 bottom">
        <div class="col-md-4">
            ...
            <img src="{{url('homestyle/images/book.png')}}" align="left" /><span class="name">
        ...
        <div class="col-md-4">
            ...
            <a href="#"><img src="{{url('homestyle/images/icon-insta.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-pin.png')}}" /></a>
            <a href="#"><img src="{{url('homestyle/images/icon-youtube.png')}}" /></a><br />
